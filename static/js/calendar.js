...
var KTAppCalendar = function () {
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Ajouter un évernement";
    ...
    // Populate form 
    const populateForm = () => {
        eventTeacher.value = data.eventTeacher ? data.eventTeacher : '';
        eventLevel.value = data.eventLevel ? data.eventLevel : '';
        eventClassroom.value = data.eventClassroom ? data.eventClassroom : '';
